    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: {
                    'wp-content/themes/Spiderweb/assets/css/style.css': 'wp-content/themes/Spiderweb/assets/sass/style.scss',
                }
            }
        },
        ...
        uglify: {
            build: {
                files: {
                    'wp-content/themes/Spiderweb/assets/js/scripts.min.js': ['wp-content/themes/Spiderweb/assets/js/*.js', '!wp-content/themes/Spiderweb/assets/js/scripts.min.js']
                },
                options: {
                    compress: false,
                    mangle: false,
        ...
        watch: {
            php: {
                files: 'wp-content/themes/Spiderweb/*.php'
            },
            css: {
            ...
            js: {
                files: ['wp-content/themes/Spiderweb/assets/js/*.js', '!wp-content/themes/Spiderweb/assets/js/scripts.min.js'],
                tasks: ['uglify']
            },
            html: {
                files: './*.html',
